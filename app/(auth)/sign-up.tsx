      ...
      >
        <View className="flex-1 justify-center px-6 py-12">
          ...
          <TouchableOpacity
            ...
            disabled={isLoading}
            className="bg-blue-500 my-4 py-4 rounded-md items-center mb-4"
          >
            {isLoading ? (
  ...
  return (
    ...
    >
      <View className="flex-1 justify-center px-6 py-12">
        ...
        <TextInput
          className="w-full mt-4 border border-gray-300 rounded-xl px-4 py-3 mb-6"
